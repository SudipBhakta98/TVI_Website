...
export default function Capabilities() {
  ...
  return (
    <section className="w-full bg-[#F8FAFC] text-slate-800 font-sans antialiased">
      ...
      {/* =========================================================================
          SECTION 2: MANUFACTURING CAPABILITIES (DYNAMIC ROUTE LINKING)
         ========================================================================= */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {capabilitiesGrid.map((cap) => (
            <Link
              ...
              className="group bg-white border border-slate-200/80 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer flex flex-col sm:flex-row"
            >
              {/* Image Frame */}
              <div className="sm:w-1/2 aspect-video sm:aspect-auto relative overflow-hidden bg-slate-100 border-r border-slate-100">
                <img
                  src={cap.image}
                  alt={cap.title}
              ...
              <div className="sm:w-1/2 p-5 flex flex-col justify-between space-y-4">
                <div>
                  <h3 className="text-base font-black text-[#12161A] group-hover:text-[#4F9B28] transition-colors uppercase tracking-wide">
                    {cap.title}
                  </h3>
                  <p className="text-slate-600 text-xs sm:text-sm mt-2 leading-relaxed font-medium line-clamp-3">
                    {cap.shortDesc}
                  </p>
                </div>

                <div className="flex items-center text-xs font-black text-[#4F9B28] gap-1 uppercase tracking-wider">
