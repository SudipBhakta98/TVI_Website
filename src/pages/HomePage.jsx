...
export default function Home() {
  ...
  // Native smooth scroll replacement for react-scroll
  const scrollToCapabilities = () => {
    const section = document.getElementById("industries-preview");
    if (section) {
  ...
  return (
    <>
      <section id="hero" className="relative w-full flex flex-col justify-between bg-[#031424] overflow-hidden">
        ...
        <div className="max-w-[90rem] mx-auto w-full px-4 sm:px-6 lg:px-8 z-10  p-10">
          <div className="max-w-3xl flex flex-col gap-5 sm:gap-6">
            ...
            >
              {/* Native Smooth Scroll Button */}
              <button 
                onClick={scrollToCapabilities}
                className="w-full sm:w-auto bg-[#0082FB] hover:bg-[#0072de] transition-colors text-white font-bold text-xs tracking-wider uppercase px-6 py-4 rounded flex items-center justify-center gap-2 cursor-pointer shadow-md"
              >
