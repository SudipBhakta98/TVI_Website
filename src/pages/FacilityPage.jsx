...
export default function Facilities() {
  return (
    <section id="facility" className="w-full bg-[#070F19] text-white antialiased font-sans overflow-hidden">
      ...
      <div className="max-w-[85rem] mx-auto px-6 md:px-12 pt-8 pb-6">
        <h2 className="text-xl md:text-2xl font-black tracking-wider uppercase text-white">
          OUR FACILITIES
        </h2>
        <div className="w-12 h-[3px] bg-lime-600 mt-2 mb-3 rounded-full" />
      ...
      {/* Facilities Grid */}
      <div className="max-w-[85rem] mx-auto px-6 md:px-12 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {facilitiesData.map((fac) => (
            <article 
              key={fac.name} 
              className="group flex flex-col bg-white border border-slate-200/80 rounded-sm overflow-hidden hover:border-lime-600/60 transition-all duration-200 shadow-sm"
            >
              ...
              <div className="p-5 flex flex-col justify-between flex-grow">
                <div>
                  <h3 className="text-xs font-bold text-slate-900 tracking-wide uppercase transition-colors group-hover:text-lime-600">
                    {fac.name}
                  </h3>
      ...
      {/* Section Divider */}
      <div className="max-w-[85rem] mx-auto px-6 md:px-12 my-8">
        <div className="w-full h-[1px] bg-slate-800/60" />
      </div>

      {/* Manufacturing Units Header */}
      <div className="max-w-[85rem] mx-auto px-6 md:px-12  pb-6">
        <h2 className="text-xl md:text-2xl font-black tracking-wider uppercase text-white">
          MANUFACTURING UNITS
        </h2>
        <div className="w-12 h-[3px] bg-lime-600 mt-2 mb-3 rounded-full" />
      ...
      {/* Units List */}
      <div className="max-w-[85rem] mx-auto px-6 md:px-12 pb-12 space-y-8">
