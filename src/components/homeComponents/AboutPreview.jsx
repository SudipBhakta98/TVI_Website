...
export default function AboutPreview() {
  return (
    <section
      id="about-preview"
      className="bg-[#F8FAFC] mt-4 px-4 lg:px-8 w-full"
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 w-full items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center space-y-4">
              ...
              <p className="text-slate-600 text-sm md:text-base leading-relaxed font-normal animate-fade-in-up [animation-delay:300ms]">
                As a Technovision specialist in high-quality metal products,
                TECHNOVISION has been combining traditional craftsmanship with
                state-of-the-art CNC metalworking since 2003. At our facility,
                we support B2B customers from the initial concept through to the
                final, ready-to-install assembly—efficiently, on schedule, and
                with ISO certification. Whether it's a prototype, small-batch
                production, or high-volume manufacturing: our combination of
                engineering expertise, flexible machinery, and authentic quality
                delivers precise results for the global machinery and equipment
